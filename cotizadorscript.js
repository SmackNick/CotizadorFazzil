...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (formInfoNegocio) {
        ...
        if (nombreEmpresa && nombreContacto && contactoInfo) {
            ...
            console.log('Intentando redirigir a detalles-cotizacion.html');
            window.location.href = 'detalles-cotizacion.html';
        } else {
    ...
    if (formDetallesCotizacion) {
        ...
        formDetallesCotizacion.addEventListener('submit', function(e) {
            ...
            if (validarFormulario()) {
                ...
                window.location.href = 'vista-previa-cotizacion.html';
            }
        });
